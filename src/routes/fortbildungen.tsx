    ...
    <>
      ...
      <section className="container-prose py-16">
        <div className="rounded-sm border border-dashed border-border bg-secondary/40 p-10 text-center">
          <p className="text-sm uppercase tracking-[0.18em] text-accent">In Vorbereitung</p>
          <h2 className="mt-3 font-display text-3xl">Aktuelle Fortbildungstermine folgen</h2>
